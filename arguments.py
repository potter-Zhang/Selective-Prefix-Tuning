...
class ModelArguments:
    ...
    selective_prefix: bool = field(
        default=False,
        metadata={
            "help": "use sigmoid to generate mask, selective mechanism"
        }
    )
    ...
    tau: float = field(
        default=1,
        metadata={
            "help": "tau for sigmoid"
        }
    )
    scores_dropout_prob: float = field(
        default=0.1,
        metadata={
            "help": "dropout probability of prefix attention scores"
        }
    )
    key_dropout_prob: float = field(
        default=0.1,
        metadata={
            "help": "dropout probability for prefix key"
        }
    )
    alpha: float = field(
        default=0.0001,
